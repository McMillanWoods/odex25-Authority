odoo.define('awesome_theme_pro.vertical_menu', function (require) {
    ...
    var AwsomeVerticalMenu = Widget.extend({
         ...
         * @param {*} menu_id 
         */
        change_menu_item: function (menu_id, disable_click) {
            var action_id = this.menu_id_to_action_id(menu_id)
            if (action_id) {
                this.change_action_item(parseInt(action_id), disable_click)
            }
        },
        
        change_action_item: function (action_id, disable_click) {
