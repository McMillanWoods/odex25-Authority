odoo.define("odex25_planning.planning_gantt_tests.js", function (require) {
    "use strict";

    const Domain = require("web.Domain");
    const PlanningGanttView = require("odex25_planning.PlanningGanttView");
    ...
    QUnit.module("Planning", {
        ...
        QUnit.test("empty gantt view with sample data: send schedule", async function (assert) {
            ...
            testUtils.mock.intercept(gantt, "do_action", function ({ data }) {
                assert.strictEqual(data.action, "odex25_planning.planning_send_action");
