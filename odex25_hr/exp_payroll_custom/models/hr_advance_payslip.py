            ...
            for holiday in holidays:
                if holiday.date_from and holiday.date_to:
                    if holiday.holiday_status_id.payslip_type == 'unpaid':
                        if payslip.date_to >= holiday.date_to and holiday.date_from >= payslip.date_from:
                            ...
                            if number_of_days >= 0:  # number_of_days <= 0
                                payslip.worked_days_line_ids = [(0, 0, {
                                    ...
                                    'number_of_hours': 0.0,
                                    'contract_id': payslip.contract_id.id})]
                        elif payslip.date_from >= holiday.date_from and payslip.date_to >= holiday.date_to:
