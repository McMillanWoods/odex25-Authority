...
class odex25_helpdeskTicket(models.Model):
    ...
    work_location = fields.Char(related='employee_id.work_location',string="Work Location")
    ...
    transform_no = fields.Char(related='employee_id.phone_ext',string="Transform Number")
