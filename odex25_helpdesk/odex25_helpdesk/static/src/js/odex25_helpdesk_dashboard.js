...
odoo.define('client_act.helpdesk_statistics_act', function (require) {
   'use strict';
   var AbstractAction = require('web.AbstractAction');
   var core = require('web.core');
   var rpc = require('web.rpc');
   var QWeb = core.qweb;
   var HelpdeskStatistics = AbstractAction.extend({
   template: 'helpdesk_statistics_main',
       events: {
       },
       ...
       load_data: function () {
           var self = this;
                   ...
                   console.log("dataaaaaa", datas)
                       self.$('.table_view').html(QWeb.render('helpdesk_statistics_template', {
                                  values : datas,
                                  widget: self,
                                  show_demo: datas.show_demo,
                                  rating_enable: datas.rating_enable,
                                  success_rate_enable: datas.success_rate_enable,
                       }));
                   });
           },

   });
   core.action_registry.add("helpdesk_statistics_act", HelpdeskStatistics);
   return HelpdeskStatistics;
});