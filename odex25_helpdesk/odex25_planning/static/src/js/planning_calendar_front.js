...
odoo.define('odex25_planning.calendar_frontend', function (require) {
"use strict";
...
publicWidget.registry.PlanningView = publicWidget.Widget.extend({
    ...
    eventFunction: function (calEvent) {
        ...
        $("#modal_action_dismiss_shift").attr("action", "/odex25_planning/" + planningToken + "/" + employeeToken + "/unassign/" + calEvent.event.extendedProps.slot_id);
