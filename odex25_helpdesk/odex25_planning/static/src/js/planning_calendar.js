odoo.define('odex25_planning.Calendar', function (require) {
"use strict";
    ...
    var PlanningCalendarPopover = CalendarPopover.extend({
        willStart: function() {
            const self = this;
            const check_group = this.getSession().user_has_group('odex25_planning.group_planning_manager').then(function(has_group) {
