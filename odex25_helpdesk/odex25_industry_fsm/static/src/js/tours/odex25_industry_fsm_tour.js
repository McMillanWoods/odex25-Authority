odoo.define('odex25_industry_fsm.tour', function (require) {
"use strict";
...
tour.register('odex25_industry_fsm_tour', {
    sequence: 10,
    url: "/web",
}, [{
    trigger: '.o_app[data-menu-xmlid="odex25_industry_fsm.fsm_menu_root"]',
